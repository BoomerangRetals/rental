...
document.addEventListener('DOMContentLoaded', function (e) {
  (function () {
    const formValidationExamples = document.getElementById('formValidationExamples'),
      formValidationSelect2Ele = jQuery(formValidationExamples.querySelector('[name="formValidationBrand"]')),
    ...
    const fv = FormValidation.formValidation(formValidationExamples, {
      fields: {
        ...
        formValidationAvailable: {
          validators: {
            notEmpty: {
              message: 'Please select fleet availability'
            }
          }
        },
        formValidationVisible: {
          validators: {
            notEmpty: {
              message: 'Please select fleet visibility'
            }
          }
        },
    ...
    if (formValidationSelect2Ele.length) {
      ...
      formValidationSelect2Ele
        ...
        .on('change.brand', function () {
          ...
          fv.revalidateField('formValidationBrand');
        });
    }
