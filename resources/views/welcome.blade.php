...
<head>
    ...
    <meta name="author" content="Boomerang Rentals">
...
<body>
	...
	<div class="page-wraper">
                ...
                <div class="header-middle main-bar">
                    <div class="logo-header">
                        <div class="logo-header-inner logo-header-one">
                            <a href="index.html">
                            <img src="images/logo-light3.png" alt="Logo">
                            </a>
                        </div>
                    </div>
        ...
        <div class="page-content">
            ...
            <div class="section-full p-t150 site-bg-white twm-w-steps-section-wrap wow fadeInDown" data-wow-offset="100" data-wow-delay="0.2" style="background-image: url(images/step-bg.jpg);">
                <div class="container">
