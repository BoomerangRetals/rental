                ...
                <div class="card-body">
                    <form action="{{ route('admin.team.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('business_title') is-invalid @enderror" 
                                       id="business_title" name="business_title" value="{{ old('business_title', $team->business_title) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            @if($team->photo)
                                <div class="mb-2">
                                    <img src="{{ $team->photo }}" alt="{{ $team->name }}" class="rounded" width="100" height="100">
                                    <small class="d-block text-muted">Current photo</small>
                                </div>
                            @endif
                            <input type="file" class="form-control @error('photo') is-invalid @enderror" 
                                   id="photo" name="photo" accept="image/*">
                            <div class="form-text">Upload new photo to replace current one (max 2MB, formats: JPEG, PNG, JPG, GIF)</div>
                            @error('photo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="card mb-4" id="ownerFields" style="{{ $team->is_chairman ? '' : 'display: none;' }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('company_message') is-invalid @enderror" 
                                              ...
                                              placeholder="Personal message from the business owner to customers...">{{ old('company_message', $team->company_message) }}</textarea>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control @error('vision_statement') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Company's vision for the future...">{{ old('vision_statement', $team->vision_statement) }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control @error('thoughts') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Business philosophy and core beliefs...">{{ old('thoughts', $team->thoughts) }}</textarea>
                                        @error('thoughts')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="url" class="form-control @error('snap') is-invalid @enderror" 
                                       id="snap" name="snap" value="{{ old('snap', $team->snap) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="visibility" name="visibility" 
                                           {{ old('visibility', $team->visibility) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_chairman" name="is_chairman" 
                                           {{ old('is_chairman', $team->is_chairman) ? 'checked' : '' }} onchange="toggleOwnerFields()">
