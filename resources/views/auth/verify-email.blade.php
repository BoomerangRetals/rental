...
>
  <head>
    ...
    <title>Boomernag Rentalsr</title>
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center mb-4 mt-2">
              <a href="{{url('/')}}" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-body fw-bold ms-1">OLT Monitor</span>
              </a>
            </div>
            <!-- /Logo -->
            ...
            <form id="resendVerificationForm" method="POST" action="{{ route('verification.send') }}">
                @csrf
                <div class="btn btn-primary w-100 mb-3" onclick="submitForm('resendVerificationForm')">RESEND VERIFICATION EMAIL</div>
            </form>
             <form id="logoutForm" method="POST" action="{{ route('logout') }}">
                @csrf
                <p class="text-center mb-0">
                    Or
                <a href="javascript:void(0);" onclick="submitForm('logoutForm')">Log Out</a>
